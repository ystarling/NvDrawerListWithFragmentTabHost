...
public class MainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mLeftDrawerListView.setAdapter(new ArrayAdapter<String>(this,
				R.layout.drawer_list_item, mLeftMenu));
		mLeftDrawerListView
				.setOnItemClickListener(new DrawerLeftItemClickListener());

		mRightDrawerListView.setAdapter(new ArrayAdapter<String>(this,
				R.layout.drawer_list_item, mRightMenu));
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		// view
		boolean drawerOpen = mDrawerLayout.isDrawerOpen(mLeftDrawerListView);
	...
	private class DrawerLeftItemClickListener implements
