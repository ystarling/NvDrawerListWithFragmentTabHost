...
public class CustomerProfileFragmentTabHost extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mTabHost.addTab(mTabHost.newTabSpec("Tab1").setIndicator("Profile"),
				ProfileFragmentTab.class, null);

	
		mTabHost.addTab(mTabHost.newTabSpec("Tab2").setIndicator("Address"),
				AddressFragmentTab.class, null);
